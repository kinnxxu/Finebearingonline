      ...
      <div className="container">
        ...
        <div className="legal-content">
          <section>
            ...
            <p>Welcome to Fine Bearing & Oil Seal Store. We value your business and your trust. This document outlines the {isPrivacy ? 'privacy practices' : 'terms of use'} for our B2B ecommerce platform.</p>
          </section>
          ...
          <section>
            ...
            <p>{isPrivacy 
              ...
              : 'As a B2B platform, users are responsible for maintaining the confidentiality of their account credentials.'}
            </p>
          </section>
